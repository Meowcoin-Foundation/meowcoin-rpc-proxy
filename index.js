const { methods } = require("@meowcoin-foundation/meowcoin-rpc");
...
1) All requests to Meowcoin core node is queued using "p-queue" and run concurrently, you set concurrency in config.json
